      ...
      <div className="relative z-10 flex min-h-full flex-col justify-between p-8 xl:p-10">
        ...
        <div className="max-w-xl pb-28">
          ...
          <div className="mt-7 flex items-center gap-3 text-white/58">
            <span className="inline-flex h-7 items-center rounded-full border border-white/15 bg-white/[0.06] px-3 text-[0.6rem] font-semibold uppercase tracking-[0.16em] text-white/62">Organização</span>
          </div>
        </div>
      </div>
    </aside>
