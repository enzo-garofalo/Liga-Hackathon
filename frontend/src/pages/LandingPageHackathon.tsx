/**
 * Landing do Hackathon #01, preservada atras de `SHOW_HACKATHON` (decisions.md §11).
 *
 * A Liga usa a plataforma para o processo seletivo, entao `/` mostra a landing do
 * seletivo. Esta continua aqui inteira para a proxima edicao do hackathon: religar
 * e trocar a chave. As referencias a empresa parceira daquela edicao sairam a pedido
 * da Liga — a proxima tera outra, ou nenhuma.
 */
import {
  ArrowRight,
  Briefcase,
...
function HeroDashboard() {
  ...
  return (
    <div className="floating-stage relative mx-auto min-h-[18rem] w-full max-w-[38rem] md:min-h-[26rem]">
      <div className="floating-panel floating-panel-liga absolute left-[17%] top-[12%] z-0 flex h-24 w-24 items-center justify-center rounded-[1.2rem] bg-white shadow-[0_38px_120px_rgba(168,135,255,0.3)] md:left-[14%] md:top-[6%] md:h-48 md:w-48 md:rounded-[1.45rem]">
...
function HowItWorks() {
  const steps = [
    ...
    { n: '03', icon: Send, title: 'Submeta no prazo', desc: 'Com os 4 integrantes confirmados, submeta até 13/06/2026.' },
          ...
          <div className="rounded-[1.1rem] border border-black/10 bg-white p-5 shadow-[0_18px_45px_rgba(20,16,30,0.04)] md:col-span-4 md:rounded-[1.2rem] md:p-6">
            <div className="flex items-start gap-4 md:items-center">
              ...
              <div>
                ...
                <h3 className="mt-1 text-base font-semibold tracking-[-0.03em] text-black md:text-xl">Campinas/SP</h3>
